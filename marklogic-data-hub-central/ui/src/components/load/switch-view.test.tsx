...
describe("Switch view component", () => {
  ...
  test("Verify styles of selected buttons", () => {
    ...
    expect(document.querySelector("#switch-view-card")).toHaveProperty("checked", true);
    expect(document.querySelector("#switch-view-list")).toHaveProperty("checked", false);
    ...
    expect(document.querySelector("#switch-view-card")).toHaveProperty("checked", false);
    expect(document.querySelector("#switch-view-list")).toHaveProperty("checked", true);
