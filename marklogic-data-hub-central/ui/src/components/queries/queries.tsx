...
const Query: React.FC<Props> = (props) => {
    ...
    useEffect(() => {
        ...
        else if (isNewQueryChanged() && searchOptions.selectedQuery !== 'select a query') {
            toggleSaveNewIcon(false);
        } else {
    ...
    }, [searchOptions, props.greyFacets, isSaveQueryChanged(), isNewQueryChanged()])
                        ...
                        <div id={'savedQueries'}>
                            {openSaveModal &&
                                <SaveQueryModal
                                    ...
                                    toggleSaveNewIcon={toggleSaveNewIcon}
