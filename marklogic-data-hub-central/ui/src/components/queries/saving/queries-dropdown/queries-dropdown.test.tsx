...
describe("Query Dropdown", () => {
  ...
  test("Render query dropdown", () => {
    const {getByLabelText} = render(<QueriesDropdown savedQueryList={[{name: "newclients"}]} currentQueryName={""} />);
  ...
  test("Explore query dropdown option", () => {
    const {getByLabelText} = render(
      <QueriesDropdown savedQueryList={[{name: "newcustomers"}]} currentQueryName={""} />,
    );
  ...
  test("Current query selected", () => {
    const {getByText} = render(<QueriesDropdown savedQueryList={[{name: "newsport"}]} currentQueryName={"newsport"} />);
