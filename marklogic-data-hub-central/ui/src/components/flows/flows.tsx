...
import {Collapse, Icon, Modal, Menu, Dropdown, Checkbox, Tooltip} from "antd";
import {FontAwesomeIcon} from "@fortawesome/react-fontawesome";
import {faCheckCircle, faCog, faInfoCircle} from "@fortawesome/free-solid-svg-icons";
      ...
      {latestJobData && latestJobData[name] && latestJobData[name].find(step => step.jobId) ?
        <HCTooltip text="Flow Status" id="flow-status-tooltip" placement="bottom">
          <span onClick={(e) => OpenFlowJobStatus(e, index, name)} className={styles.infoIcon}>
            <i><FontAwesomeIcon icon={faInfoCircle} size="1x" data-testid={name + "-StatusIcon"} /></i>
          </span>
        </HCTooltip>
        : ""
      }
