...
describe("Test for entity map table", () => {
  it("Verify version in info links", async () => {
    ...
    expect((await screen.findAllByLabelText("Custom-Functions"))[0])
      .toHaveAttribute("href", "https://docs.marklogic.com/datahub/6.0/flows/create-custom-mapping-functions.html");

    expect((await screen.findAllByLabelText("Mapping-Functions"))[0])
      .toHaveAttribute("href", "https://docs.marklogic.com/datahub/6.0/flows/dhf-mapping-functions.html");

    userEvent.hover(screen.getAllByTestId("relatedInfoIcon")[0]);
    expect((await screen.findAllByLabelText("link-Documentation"))[0])
      .toHaveAttribute("href", "https://docs.marklogic.com/datahub/6.0/flows/about-mapping.html");
  });
});