          ...
          <span className={row.joinPropertyName !== "" || !expanded ? styles.renderContainer : styles.noKeyContainer}>
            ...
            {row.joinPropertyName !== "" ?
              ...
              <div className={styles.dualIconsContainer}>
                ...
                <HCTooltip text={ModelingTooltips.foreignKeyMapping(relatedEntityName, row.joinPropertyName, props.entityTypeTitle, row.name)} id={"tooltip-" + row.name} placement="bottom">
