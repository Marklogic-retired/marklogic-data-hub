  ...
  return (
    <HCModal show={props.isVisible} onHide={closeModal}>
      ...
      <Modal.Body className={"pt-0 px-4"}>
        <p aria-label="delete-slider-text">
          Are you sure you want to delete a&nbsp;
          <span>{props.editRuleset.hasOwnProperty("name") ? "ruleset" : "threshold"}</span>&nbsp;
          <b>
            {props.editRuleset.hasOwnProperty("name")
              ? props.editRuleset.name
              : props.editRuleset.thresholdName + " - " + props.editRuleset.action}{" "}
          </b>{" "}
          ?
        </p>
        <div className={"d-flex justify-content-center pt-4 pb-2"}>
          <HCButton
            aria-label={
              props.editRuleset.hasOwnProperty("name")
                ? `confirm-${props.editRuleset.name}-no`
                : `confirm-${props.editRuleset.thresholdName}-no`
            }
          ...
          <HCButton
            aria-label={
              props.editRuleset.hasOwnProperty("name")
                ? `confirm-${props.editRuleset.name}-yes`
                : `confirm-${props.editRuleset.thresholdName}-yes`
            }
            variant="primary"
