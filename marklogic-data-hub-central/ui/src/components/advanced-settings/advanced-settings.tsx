...
const AdvancedSettings: React.FC<Props> = (props) => {
  ...
  const tgtDatabase = React.createRef<HTMLSpanElement>();
  ...
  const tgtCollectionRef = React.createRef<HTMLSpanElement>();
  ...
  const tgtPermissionRef = React.createRef<HTMLInputElement>();
  ...
  const batchSizeRef = React.createRef<HTMLInputElement>();
  ...
  const serviceNameKeyDownHandler = async (event, component) => {
      ...
      //Tooltip visible when user presses space or enter key tgtPermissionTooltip
      ...
      if ((event.keyCode === 27)) {
          if(component === "tgtDatabaseTooltip") setTgtDatabaseTooltipVisible2(false);
          if(component === "tgtCollectionTooltip") setTgtCollectionTooltipVisible2(false);
          if(component === "tgtPermissionTooltip") setTgtPermissionToolTipVisible(false);
          if(component === "provGranularityTooltip") setProvGranTooltipVisible2(false);
          if(component === "batchSizeTooltip") setBatchSizeToolTipVisible(false);
          if(component === "headerContentTooltip") setHeaderContentTooltipVisible(false);
          if(component === "interceptorTooltip") setInterceptorTooltipVisible(false);
          if(component === "customHookTooltip") setCustomHookTooltipVisible(false);
      }
      ...
      //enter key cancel Button and save Button headerContent
      if (event.keyCode === 13) {
      ...
      if(event.keyCode === 9 && component === "tgtDatabase" && !event.shiftKey) setTgtDatabaseTooltipVisible(false)
      if(event.keyCode === 9 && component === "tgtDatabase" && event.shiftKey) setTgtDatabaseTooltipVisible(!tgtDatabaseTooltipVisible)
      if(event.keyCode === 9 && component === "tgtDatabaseTooltip" && !event.shiftKey) setTgtCollectionTooltipVisible(true)
      if(event.keyCode === 9 && component === "tgtDatabaseInner" && event.shiftKey) setTgtDatabaseTooltipVisible(true)
      if(event.keyCode === 9 && component === "tgtDatabaseInner") {
          if(!event.shiftKey) setTgtDatabaseTooltipVisible(!tgtDatabaseTooltipVisible)
      }
      if(event.keyCode === 9 && component === "tgtCollection"){
          if(!event.shiftKey) setTgtCollectionTooltipVisible(false)
          else setTgtCollectionTooltipVisible(!tgtCollectionTooltipVisible)
      }
      if(event.keyCode === 9 && component === "tgtCollectionInner") {
         if(event.shiftKey) {
             setTgtCollectionTooltipVisible(true)
         }
         else setTgtCollectionTooltipVisible(!tgtCollectionTooltipVisible)
      }
      if(event.keyCode === 9 && component === "tgtPermissionTooltip"){
          if(!event.shiftKey) {
              // provGranTooltipRef.current!.focus();
              setProvGranTooltipVisible(true);
          }
      }
      if(event.keyCode === 9 && component === "provGranularity") {
          if(!event.shiftKey) setProvGranTooltipVisible(false);
          else setProvGranTooltipVisible(!provGranTooltipVisible)
      }
      if(event.keyCode === 9 && component === "provGranularityInner") {
    ...
    <div>
      ...
      <Form onSubmit={handleSubmit} className={"container-fluid"}>
        ...
        <Row className={"mb-3"}>
          ...
          <Col className={"d-flex"}>
            <OverlayTrigger overlay={<Tooltip id="button-tooltip12">{keyboardNavigationTooltips.dropdownUserInfo}</Tooltip>} placement="left" show={tgtDatabaseTooltipVisible}>
            ...
            <div className={"p-2 d-flex"}>
              <HCTooltip
                ...
                placement="left"
                show={tgtDatabaseTooltipVisible2}
              >
                <QuestionCircleFill aria-label="icon: question-circle" color="#7F86B5" size={13} />
              </HCTooltip>
            </div>
        ...
        {usesAdvancedTargetCollections ?
          ...
          <Row className={"mb-3"}>
            <FormLabel column lg={3}>{"Target Collections:"}</FormLabel>
            <Col className={"d-flex"} data-testid={"target-collections"}>
              <OverlayTrigger overlay={<Tooltip id="button-tooltip12">{keyboardNavigationTooltips.dropdownUserInfo}</Tooltip>} placement="left" show={tgtCollectionTooltipVisible}>
              ...
              <div className={"p-2 d-flex"}>
                <HCTooltip
                  ...
                  placement="left"
                  show={tgtCollectionTooltipVisible2}
                >
                  <QuestionCircleFill aria-label="icon: question-circle" color="#7F86B5" size={13} />
                </HCTooltip>
              </div></span>
              ...
              <Col xs={12} className={"d-flex"}>
                ...
                <div className={"p-2 d-flex"}>
                  <HCTooltip
                    ...
                    placement="left"
                    show={tgtPermissionTooltipVisible}
                  >
                    <QuestionCircleFill aria-label="icon: question-circle" color="#7F86B5" size={13} />
                  </HCTooltip>
                </div>
        ...
        <Row className={"mb-3"}>
          ...
          <Col className={"d-flex"}>
            <OverlayTrigger overlay={<Tooltip id="button-tooltip">{keyboardNavigationTooltips.dropdownUserInfo}</Tooltip>} placement="left" show={provGranTooltipVisible}>
                ...
                <Col className={"d-flex"}>
                  ...
                  <div className={"p-2 d-flex align-items-center"}>
                    <HCTooltip
                      ...
                      id="headers-tooltip"
                      placement="left"
                      show={headerContentTooltipVisible}
                    >
                      <QuestionCircleFill aria-label="icon: question-circle" color="#7F86B5" size={13} />
                    </HCTooltip>
                  </div>
                ...
                <Col className={"d-flex"}>
                  ...
                  <div className={"p-2 d-flex align-items-center"}>
                    <HCTooltip
                      ...
                      placement="left"
                      show={interceptorTooltipVisible}
                    >
                      <QuestionCircleFill aria-label="icon: question-circle" color="#7F86B5" size={13} />
                    </HCTooltip>
                  </div>
