...
describe("Steps settings component", () => {
  ...
  test("Verify rendering of step warning", async () => {
    ...
    expect(getByText("Warning: Target Collections includes the target entity type Person")).toBeInTheDocument();
    expect(getByText("Warning: Target Collections includes the source collection loadPersonJSON")).toBeInTheDocument();
  });
