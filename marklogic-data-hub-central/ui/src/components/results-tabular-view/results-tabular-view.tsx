...
import { CodeSolid, ExternalLinkAltSolid } from '@marklogic/design-system/es/MLIcon';
                ...
                <Link to={{
                    ...
                    <Tooltip title={'Show the processed data'}>
                        <i className={styles.separateLink}>
                            <ExternalLinkAltSolid data-testid={`${primaryKeyValue}-detailOnSeparatePage`} />
                        </i>
                    </Tooltip>
                </Link>
                <Link to={{
                    ...
                    <Tooltip title={'Show the complete ' + item.format.toUpperCase()}>
                        <i className={styles.separateLink}>
                            <CodeSolid data-testid={`${primaryKeyValue}-sourceOnSeparatePage`} />
                        </i>
                    </Tooltip>
                </Link>
            </div>
