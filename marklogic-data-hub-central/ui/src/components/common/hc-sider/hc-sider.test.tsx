...
test("should render a Slider component ", () => {
  render(
    <HCSider placement="left" show={true}>
      This is an sider
    </HCSider>,
  );
...
test("should render a footer inside the Slider component ", () => {
  render(
    <HCSider placement="left" show={true} footer={<span>The footer</span>}>
      This is an sider
    </HCSider>,
  );
  const siderElement = screen.getByTestId("hc-sider-component");
...
test("should not render a Slider component ", () => {
  render(
    <HCSider placement="left" show={false}>
      This is an sider
    </HCSider>,
  );
...
test("should render a Slider component with the personlized testid ", () => {
  render(
    <HCSider placement="left" identity="Custom" show={true} footer={<span>The footer</span>}>
      This is an sider
    </HCSider>,
  );
