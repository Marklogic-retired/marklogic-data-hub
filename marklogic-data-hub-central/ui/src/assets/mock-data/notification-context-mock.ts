    ...
    notifications: [
      {
        ...
        "uris": [
          {"uri": "/com.marklogic.smart-mastering/merged/ecbd43241f2e14a06ccd24deb79ab0c5.json"},
          {"uri": "/json/persons/ssn-match1.json"},
        ],
      },
      {
        "meta": {
        ...
        "thresholdLabel": "Likely Match",
        "uris": [
          {"uri": "/json/persons/last-name-address-reduce1.json"},
          {"uri": "/json/persons/last-name-address-reduce2.json"},
        ],
      },
    ],
    totalCount: 4,
