...
describe("Mapping", () => {
  ...
  // TODO skip until we fix: https://project.marklogic.com/jira/browse/DHFPROD-7429
  it.skip("Edit advanced settings for each entity", () => {
  ...
  it("Add and test mapping expressions with related entities", () => {
    ...
    // More visible on search by name for structured property
