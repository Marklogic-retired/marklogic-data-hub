...
describe("Validate Merge warnings", () => {
  ...
  it("Navigate to merge step and validate warning messages", () => {
    ...
    curatePage.alertMessage().eq(0).should("have.text", "Warning: Target Collections includes the source collection match-person");
    ...
    curatePage.alertMessage().eq(1).should("have.text", "Warning: Target Collections includes the source collection match-person");
