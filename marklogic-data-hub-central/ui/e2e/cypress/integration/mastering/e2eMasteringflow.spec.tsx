...
describe("Validate E2E Mastering Flow", () => {
  ...
  it("Map source to entity", () => {
    sourceToEntityMap.setXpathExpressionInput("FirstName", "FirstName");
    sourceToEntityMap.setXpathExpressionInput("LastName", "LastName");
    sourceToEntityMap.setXpathExpressionInput("SSN", "SSN");
    sourceToEntityMap.setXpathExpressionInput("ZipCode", "ZipCode");
    sourceToEntityMap.setXpathExpressionInput("Address", "Address");
    sourceToEntityMap.setXpathExpressionInput("DateOfBirth", "DateOfBirth");
    curatePage.dataPresent().should("be.visible");
    sourceToEntityMap.expandCollapseSource().click({force: true});
    // Test the mappings
    cy.waitUntil(() => sourceToEntityMap.testMap().should("be.enabled"));
    cy.waitUntil(() => sourceToEntityMap.expandCollapseEntity()).click();
  ...
  it("Add Rulesets", () => {
    ...
    cy.waitForAsyncRequest();
    sourceToEntityMap.goBackToCurateHomePage();
  });
