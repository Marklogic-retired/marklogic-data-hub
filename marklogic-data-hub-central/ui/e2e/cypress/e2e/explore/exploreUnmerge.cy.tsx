...
describe("Test '/Explore' graph right panel", () => {
  ...
  it("Unmerge record and validate include unmerged documents checkbox", () => {
    ...
    compareValuesModal.getUnmergeButton().click().then(() => {
      cy.findByText("Are you sure you want to unmerge this document? Doing so, the original documents will be moved out of the archive collection and also considered for future matches.").should("be.visible");
    });
  ...
  it("Unmerge record and validate document is not merged again", () => {
    ...
    compareValuesModal.getModal().should("be.visible");
    compareValuesModal.getUnmergeButton().click().then(() => {
      cy.findByText("Are you sure you want to unmerge this document? Doing so, the original documents will be moved out of the archive collection and be prevented from future match consideration.").should("be.visible");
    });
    compareValuesModal.confirmationYes().click();
    compareValuesModal.getModal().should("not.exist");
