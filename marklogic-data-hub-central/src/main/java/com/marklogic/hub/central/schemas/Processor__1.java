...
public class Processor__1 {
     ...
     */
    @JsonProperty("vars")
    public void setVars(Vars__1 vars) {
        this.vars = vars;
    }
    ...
    public String toString() {
        ...
        sb.append(Processor__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("path");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Processor__1) == false) {
            return false;
        }
        Processor__1 rhs = ((Processor__1) other);
