...
public class FlowError__1 {
    ...
    public String toString() {
        ...
        sb.append(FlowError__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FlowError__1) == false) {
            return false;
        }
        FlowError__1 rhs = ((FlowError__1) other);
