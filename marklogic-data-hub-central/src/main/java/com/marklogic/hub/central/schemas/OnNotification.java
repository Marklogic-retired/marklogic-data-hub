...
public class OnNotification {
    ...
    public String toString() {
        ...
        sb.append(OnNotification.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("add");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OnNotification) == false) {
            return false;
        }
        OnNotification rhs = ((OnNotification) other);
