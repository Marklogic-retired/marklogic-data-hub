...
public class OnArchive {
    ...
    public String toString() {
        ...
        sb.append(OnArchive.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("add");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OnArchive) == false) {
            return false;
        }
        OnArchive rhs = ((OnArchive) other);
