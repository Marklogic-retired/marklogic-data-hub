...
public class MergeOptions {
    ...
    public String toString() {
        ...
        sb.append(MergeOptions.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("lang");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MergeOptions) == false) {
            return false;
        }
        MergeOptions rhs = ((MergeOptions) other);
