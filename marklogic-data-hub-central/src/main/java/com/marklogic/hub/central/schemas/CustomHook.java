...
public class CustomHook {
    ...
    public String toString() {
        ...
        sb.append(CustomHook.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("module");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CustomHook) == false) {
            return false;
        }
        CustomHook rhs = ((CustomHook) other);
