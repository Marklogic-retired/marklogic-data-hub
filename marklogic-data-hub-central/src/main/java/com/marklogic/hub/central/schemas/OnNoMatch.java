...
public class OnNoMatch {
    ...
    public String toString() {
        ...
        sb.append(OnNoMatch.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("add");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OnNoMatch) == false) {
            return false;
        }
        OnNoMatch rhs = ((OnNoMatch) other);
