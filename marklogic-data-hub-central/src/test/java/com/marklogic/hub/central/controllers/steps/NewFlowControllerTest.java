...
public class NewFlowControllerTest extends AbstractMvcTest {
    ...
    void test() throws Exception {
        ...
        MappingStepController.MappingInfo mappingInfo = MappingStepControllerTest.newDefaultMappingInfo();
        StepService.on(getHubClient().getStagingClient()).createStep(stepDefinitionType, mappingInfo.toJsonNode());
