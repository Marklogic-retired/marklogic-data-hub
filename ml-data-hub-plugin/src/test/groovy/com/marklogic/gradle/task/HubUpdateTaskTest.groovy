...
class HubUpdateTaskTest extends BaseTest {
    ...
    def setup() {
        //hardcoding to 4.0
        File hubConfigDir = hubConfig().hubProject.projectDir.resolve("src/main/hub-internal-config-4.1.0-rc2").toFile()
        File mlConfigDir = hubConfig().hubProject.projectDir.resolve("src/main/ml-config-4.1.0-rc2").toFile()
