 ...
 */
public class AllTablesColumnMapProcessor implements ItemProcessor<Map<String, Object>, DocumentWriteOperation> {
    ...
    public AllTablesColumnMapProcessor(ColumnMapSerializer columnMapSerializer) {
