...
function main(content, options) {
  ...
  // MOD: we will redact the entire doc below, so no need for the raw instance:
  ...
  let instance = datahub.flow.flowUtils.getInstanceAsObject(redactedMember) || {};

  //----  instance now set to redacted version
