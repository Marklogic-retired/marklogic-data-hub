...
You will want to download the latest 4.x release of the [QuickStart Application](https://github.com/marklogic/marklogic-data-hub/releases/download/4.0.3/quick-start-4.0.3.war) and save it in this directory.
