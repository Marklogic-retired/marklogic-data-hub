const mlSmMatchRest = require("/marklogic.rest.resource/mlSmMatch/assets/resource.xqy");
...
const validResults = mlSmMatchRest.post(context, validMatchParams, emptyDocument).toObject();
