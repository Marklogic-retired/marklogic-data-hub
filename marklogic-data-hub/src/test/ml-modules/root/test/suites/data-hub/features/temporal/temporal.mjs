...
const resultQuery = temporalFeature.onBuildInstanceQuery(stepContext, model, sourceQuery);
assertions.push(test.assertTrue(resultQuery, "cts.andQuery[cts.collectionQuery(['latest']),cts.collectionQuery(['raw-content'])]"));
