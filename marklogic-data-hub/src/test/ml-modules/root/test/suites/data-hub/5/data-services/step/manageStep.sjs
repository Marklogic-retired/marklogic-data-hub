...
let serviceResponse = stepService.createStep(stepDefinitionType, info);
expectedStep.sourceDatabase = "data-hub-STAGING";
expectedStep.targetDatabase = "data-hub-FINAL";
expectedStep.collections = ["default-mapping", "mdm-content"];
...
serviceResponse = stepService.updateStep(stepDefinitionType, stepName, propertiesToAssign);
