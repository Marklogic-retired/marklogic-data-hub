...
stepService.createStep(stepDefinitionType, info);
...
assertions.push(
  ...
  test.assertEqual("default-mapping", options.collections[0]),
  test.assertEqual("mdm-content", options.collections[1]),
  test.assertEqual(false, options.validateEntity),
