...
public class MappingManagerTest extends HubTestBase {
    ...
    public void createMapping() {
        ...
        assertTrue(Paths.get((getFlowDeveloperConfig().getHubMappingsDir().toString()), mappingName, mappingFileName).toFile().exists());
    ...
    public void deleteMapping() {
        ...
        assertFalse(Paths.get((getFlowDeveloperConfig().getHubMappingsDir().toString()), mappingName, mappingFileName).toFile().exists());

    }

    private void copyTestMap() {
        FileUtil.copy(getResourceStream("scaffolding-test/"+mappingName+"-1"+MappingManager.MAPPING_FILE_EXTENSION), getFlowDeveloperConfig().getHubMappingsDir().resolve(mappingName+"/"+mappingName+"-1"+MappingManager.MAPPING_FILE_EXTENSION).toFile());
    }

    private void copySecondTestMap() {
        FileUtil.copy(getResourceStream("scaffolding-test/"+mappingName+"-2"+MappingManager.MAPPING_FILE_EXTENSION), getFlowDeveloperConfig().getHubMappingsDir().resolve(mappingName+"/"+mappingName+"-2"+MappingManager.MAPPING_FILE_EXTENSION).toFile());
    }
