...
public class MappingManagerTest extends HubTestBase {
    ...
    private        MappingManager manager = MappingManager.getMappingManager(getHubConfig(true));
    ...
    public void createMapping() {
        ...
        assertTrue(Paths.get((getHubConfig(true).getHubMappingsDir().toString()), mappingName, mappingFileName).toFile().exists());
    ...
    public void deleteMapping() {
        ...
        assertFalse(Paths.get((getHubConfig(true).getHubMappingsDir().toString()), mappingName, mappingFileName).toFile().exists());

    }

    private void copyTestMap() {
        FileUtil.copy(getResourceStream("scaffolding-test/"+mappingName+"-1"+MappingManager.MAPPING_FILE_EXTENSION), getHubConfig(true).getHubMappingsDir().resolve(mappingName+"/"+mappingName+"-1"+MappingManager.MAPPING_FILE_EXTENSION).toFile());
    }

    private void copySecondTestMap() {
        FileUtil.copy(getResourceStream("scaffolding-test/"+mappingName+"-2"+MappingManager.MAPPING_FILE_EXTENSION), getHubConfig(true).getHubMappingsDir().resolve(mappingName+"/"+mappingName+"-2"+MappingManager.MAPPING_FILE_EXTENSION).toFile());
    }
    ...
    private HubModuleManager getPropsMgr() {
        String timestampFile = getHubConfig(true).getUserModulesDeployTimestampFile();
