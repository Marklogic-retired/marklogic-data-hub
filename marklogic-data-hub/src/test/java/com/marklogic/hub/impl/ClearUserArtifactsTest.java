...
class ClearUserArtifactsTest extends AbstractHubCoreTest {
    ...
    void clearUserArtifacts() {
        try{
            ...
            assertTrue(e.getMessage().contains("Local message: failed to POST at /data-hub/data-services/artifacts/clearUserArtifacts.mjs: Bad Request. Server Message: SEC-PERMDENIED"));
