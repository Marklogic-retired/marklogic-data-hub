...
public class LoadUserFinalModulesCommand extends AbstractCommand {
    ...
    public LoadUserFinalModulesCommand(HubConfig hubConfig) {
    ...
    public void execute(CommandContext context) {
        ...
        entityManager.deployFinalQueryOptions();
