...
public class MatchingStepDefinitionImpl extends AbstractStepDefinition {

    public MatchingStepDefinitionImpl(String name) {
        setName(name);
        setType(StepDefinitionType.MATCHING);
