...
public class ApplicationConfig {
    ...
    /**
     * As of 5.3.0, HubConfigImpl is no longer a Component. But users of this class expect it to be present in the
     * Spring container, so it's declared as a Bean here.
     *
     * @return
     */
    @Bean
