...
module namespace run-sjs-flow = "http://marklogic.com/rest-api/transform/dh_sjs-input-flow";
...
declare private variable $modPath := "/data-hub/4/transforms/run-sjs-flow.sjs";
