...
const debug = require("/data-hub/5/impl/debug-lib.xqy");
const hul = require("/data-hub/5/impl/hub-utils-lib.xqy");
const json=require("/MarkLogic/json/json.xqy");
const functx = require("/MarkLogic/functx/functx-1.0-nodoc-2007-01.xqy");
if (!this.rfc) {
  this.rfc = require("/data-hub/5/impl/run-flow-context.sjs");
}
const tracelib = require("/data-hub/5/impl/trace-lib.sjs");
const flowlib = require("/data-hub/5/impl/flow-lib.xqy");
...
function runWriters(identifiers) {
  let updatedSettings =
    fn.head(xdmp.eval(
    '  let flowlib = require("/data-hub/5/impl/flow-lib.sjs"); ' +
    '  let rfc = require("/data-hub/5/impl/run-flow-context.sjs"); ' +
    '  let tracelib = require("/data-hub/5/impl/trace-lib.sjs"); ' +
