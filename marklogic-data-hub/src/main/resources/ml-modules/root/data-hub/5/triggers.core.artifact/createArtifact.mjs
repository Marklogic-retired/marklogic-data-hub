...
try {
  ...
  invokeFeatureMethods(artifactType, artifactName, "onArtifactSave");

} catch (e) {
  httpUtils.throwBadRequestWithArray(["Error running onArtifactSave on features at URI: " + uri + "; cause: " + e.message, xdmp.toJsonString(e.stackFrames)]);
}
