...
module namespace runFlow = "http://marklogic.com/rest-api/extensions/runFlow";
...
declare private variable $extName := "runFlow";
declare private variable $modPath := "/data-hub/5/extensions/runFlow.sjs";
