...
*/
const consts = require("consts.sjs");
const debug = require("debug-lib.xqy");
const hul = require("hub-utils-lib.xqy");
const json=require("/MarkLogic/json/json.xqy");
const functx = require("/MarkLogic/functx/functx-1.0-nodoc-2007-01.xqy");
if (!this.rfc) {
  this.rfc = require("run-flow-context.sjs");
}
const tracelib = require("trace-lib.sjs");
const flowlib = require("flow-lib.xqy");
