...
export class EntityModel {
  ...
  propertyValues(propertyPath, documentNode) {
    ...
    return propertyDefinition.path ? documentNode.xpath(`${propertyDefinition.path}[string(.) ne '']`, this._namespaces) : documentNode.xpath(`.//${propertyDefinition.namespace ? "ns:": ""}${propertyDefinition.localname}[string(.) ne '']`, {ns: propertyDefinition.namespace});
  }
