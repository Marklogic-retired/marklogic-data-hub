	...
	stages{
		...
		stage('code-review'){
		 when {
            ...
            allOf {changeRequest author: '', authorDisplayName: '', authorEmail: '', branch: '', fork: '', id: '', target: 'feature/5.6-develop', title: '', url: ''}
  			beforeAgent true
		 }
		...
		when {
            expression {return isPRMergable()}
            changeRequest author: '', authorDisplayName: '', authorEmail: '', branch: '', fork: '', id: '', target: 'feature/5.6-develop', title: '', url: ''
  			beforeAgent true
		}
		agent {label 'dhmaster'}
