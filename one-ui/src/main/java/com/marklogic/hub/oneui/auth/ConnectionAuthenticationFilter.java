...
public class ConnectionAuthenticationFilter extends
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        String mlHost = loginInfo.mlHost;
        ...
        EnvironmentInfo originalEnvironmentInfo = environmentService.getEnvironment();
        EnvironmentInfo environmentInfo;
        if (!(mlHost == null || StringUtils.isEmpty(mlHost))) {
            environmentInfo = new EnvironmentInfo(mlHost, loginInfo.mlAuthMethod, loginInfo.mlPort, loginInfo.mlManageAuthMethod, loginInfo.mlManagePort, loginInfo.dhStagingAuthMethod, loginInfo.dhStagingPort, loginInfo.dhFinalAuthMethod, loginInfo.dhFinalPort);
            environmentService.setEnvironment(environmentInfo);
        } else {
            environmentInfo = originalEnvironmentInfo;
        }
        ...
        ConnectionAuthenticationToken authRequest = new ConnectionAuthenticationToken(
                username, password, environmentInfo.mlHost);
