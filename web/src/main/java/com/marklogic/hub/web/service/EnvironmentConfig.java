...
public class EnvironmentConfig {
    ...
    public void checkIfInstalled() {
        ...
        // Replace "-rc1" in version with ".0" as QS compares versions and fails if version number contains text
        installedVersion = installedVersion.replace("-rc1", ".0");
        runningVersion = runningVersion.replace("-rc1", ".0");
        DHFVersion = DHFVersion.replace("-rc1", ".0");
    }
