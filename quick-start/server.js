...
middleware.init(swaggerMockDocPath, (err) => {
  ...
  myDB.save(
    ...
    new Resource('flows', 'flow-03', {'id':'flow-03','name':'Customer Flow','description':'My Customer Flow flow desc','batchSize':100,'threadCount':4,'options':{'key':'value','key2':'value1','key3':'value1'},'steps':[{ id: 'step-1-flow-3', name:'Flow 03 Ingest Step', type:'ingestion' },{ id: 'step-2-flow-3', name:'Flow 03 Mapping Step', type:'mapping', targetEntity: 'Order' },{ id: 'step-3-flow-3', name:'Flow 03 Mastering Step', type:'mastering', targetEntity: 'Order' },{ id: 'step-4-flow-3', name:'Flow 03 Custom Step', type:'custom', targetEntity: 'Order' }],'jobs':['job-1-flow-3'],'latestJob':{'id':'job-1-flow-3','flowId':'flow-3','startTime':'2019-02-02 12:10:00','endTime':'2019-02-02 16:10:00','output':[],'status':'errored','runningPercent':null,'successfulEvents':0,'failedEvents':500},'isValid':true,'isRunning':false,'version':1}),
    new Resource('flows', 'flow-04', {'id':'flow-04','name':'Product Ingestion','description':'My Product Ingestion Flow flow desc','batchSize':100,'threadCount':4,'options':{'key':'value','key2':'value1','key3':'value1'},'steps':[{ id: 'step-1-flow-4', name:'Flow 04 Custom Step', type:'custom', targetEntity: 'Order' }],'jobs':[],'latestJob':null,'isValid':false,'isRunning':false,'version':1}),
