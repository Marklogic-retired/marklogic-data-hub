...
let collections = {
  'flows': [
    {'id':'flow-01','name':'Order Flow 01','description':'My Flow01 flow desc','batchSize':100,'threadCount':4,'options':{'key':'value','key2':'value1','key3':'value1'},'steps':[{ id: 'step-1-flow-1', type:'ingestion' },{ id: 'step-2-flow-1', type:'mapping', targetEntity: 'Order' },{ id: 'step-3-flow-1', type:'mastering', targetEntity: 'Order' },{ id: 'step-4-flow-1', type:'custom', targetEntity: 'Order' }],'jobs':['job-1-flow-1','job-2-flow-1','job-3-flow-1','job-4-flow-1'],'latestJob':{'id':'job-4-flow-1','flowId':'flow-1','startTime':'2019-01-31 12:10:00','endTime':'2019-01-31 13:10:00','output':[],'status':'running','runningPercent':85,'successfulEvents':500,'failedEvents':0},'isValid':true,'isRunning':false,'version':1},
    ...
    {'id':'flow-03','name':'Customer Flow','description':'My Customer Flow flow desc','batchSize':100,'threadCount':4,'options':{'key':'value','key2':'value1','key3':'value1'},'steps':[{ id: 'step-1-flow-3', type:'ingestion' },{ id: 'step-2-flow-3', type:'mapping', targetEntity: 'Order' },{ id: 'step-3-flow-3', type:'mastering', targetEntity: 'Order' },{ id: 'step-4-flow-3', type:'custom', targetEntity: 'Order' }],'jobs':['job-1-flow-3'],'latestJob':{'id':'job-1-flow-3','flowId':'flow-3','startTime':'2019-02-02 12:10:00','endTime':'2019-02-02 16:10:00','output':[],'status':'errored','runningPercent':null,'successfulEvents':0,'failedEvents':500},'isValid':true,'isRunning':false,'version':1},
    {'id':'flow-04','name':'Product Ingestion','description':'My Product Ingestion Flow flow desc','batchSize':100,'threadCount':4,'options':{'key':'value','key2':'value1','key3':'value1'},'steps':[{ id: 'step-1-flow-4', type:'custom', targetEntity: 'Order' }],'jobs':[],'latestJob':null,'isValid':false,'isRunning':false,'version':1}
  ],
  'steps': [
