...
export class ConfirmDirective implements OnDestroy, OnChanges, OnInit {
   ...
   * @private
   */
  popover: ComponentRef<ConfirmPopoverComponent> = null;
  ...
  private showPopover(): void {
    if (!this.popover && !this.isDisabled) {
      ...
      const componentFactory: ComponentFactory<ConfirmPopoverComponent> = this.cfr.resolveComponentFactory(ConfirmPopoverComponent);
