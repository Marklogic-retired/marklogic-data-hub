...
import {NewFlowUiComponent} from "../../../components";
...
import { Component, Input, Output, EventEmitter, NgModule } from '@angular/core';
  ...
  .add('New Flow Component', () => ({
    ...
    props: { 
      ...
      startingScaffoldOption: object('startingScaffoldOption', { label: 'Create Structure from Entity Definition', value: true }),
