...
import {JobOutputUiComponent} from "../../../components";
...
storiesOf('Components|Jobs', module)
  ...
  .add('Job Output Component', () => ({
    ...
    props: { 
      ...
      cancelClicked: action('Toggle Select Job')
    }
  }));
