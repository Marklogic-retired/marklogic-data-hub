...
import {ThemeModule, HasBugsDialogComponent} from '../../../components';
...
export class HasBugsDialogButtonModule {}
 ...
 storiesOf('Components|Has Bugs Dialog', module)
    ...
    .add('Has Bugs Dialog Component', () => ({
        ...
        `,
        props: {
          errors: object('errors', {'content':{'msg':'JS-JAVASCRIPT: createContent: createContent555 -- Error running JavaScript request: ReferenceError: createContent555 is not defined','uri':'/entities/Order/input/Load Orders/content/content.sjs','line':16,'column':17}})
        },
    }));
