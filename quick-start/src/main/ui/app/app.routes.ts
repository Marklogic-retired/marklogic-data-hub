...
export const ROUTES: Routes = [
  ...
  { path: 'flows/:action/:entityName/:flowName/:flowType/:plugin', component: FlowsComponent, canActivate: [AuthGuard] },
  { path: 'flows/:action/:entityName/:flowName/:flowType', component: FlowsComponent, canActivate: [AuthGuard] },
