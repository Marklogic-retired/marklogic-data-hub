...
__This tutorial is for version 1.x of the Data Hub Framework which was designed to work with MarkLogic 8. This version is no longer being actively developed. If you are using MarkLogic 9, go to the [2.x Getting Started Tutorial](2x.md)__
